...
public:
	...
	int GetScaleT(CDC* pDC, int time_minut);
	int GetScaleG(CDC* pDC, int glub_metr);
	...
	void SetColorInterface(MColorInterface& color_interface);
...
public:
	...
	virtual CMenu* SetModulesExtern(){return 0;}
